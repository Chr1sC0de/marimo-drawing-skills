...
Use this reference when creating or debugging diagrams with the Python `diagrams` package from mingrammer.
...
```bash
python diagrams/scripts/list_diagrams_nodes.py --provider aws --query ecs
python diagrams/scripts/list_diagrams_nodes.py --provider onprem --category database
```
